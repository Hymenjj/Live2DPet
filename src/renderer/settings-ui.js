...
function updateTokenStatsUI() {
    ...
    const stats = petSystem.aiClient.getTokenStats();
    document.getElementById('stat-requests').textContent = stats.requestCount.toLocaleString();
    document.getElementById('stat-total').textContent = stats.totalTokens.toLocaleString();
    document.getElementById('stat-prompt').textContent = stats.promptTokens.toLocaleString();
    document.getElementById('stat-completion').textContent = stats.completionTokens.toLocaleString();
    document.getElementById('stat-rate').textContent = stats.tokensPerMinute.toLocaleString();
}
...
document.getElementById('btn-reset-stats').addEventListener('click', () => {
    if (petSystem && petSystem.aiClient) {
        petSystem.aiClient.resetTokenStats();
        updateTokenStatsUI();
    }
});
